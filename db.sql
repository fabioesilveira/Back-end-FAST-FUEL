...
('Sprite', 3.00, 'beverages', 'https://i.ibb.co/W4ttKBwP/48-487814-sprite-lemon-lime-can.webp', '12 fl oz'),
...
('Mozzarella Sticks', 4.00, 'sides', 'https://i.ibb.co/5XJ1tJJ1/yummy-delicious-mozzarella-sticks-isolated-white-background-generative-ai-362882027.jpg', 'Crispy on the outside, melty on the inside. Served hot with marinara dipping sauce for extra flavor punch!'),
...
('Carrot Cake', 5.00, 'desserts', 'https://static.vecteezy.com/system/resources/thumbnails/049/390/139/small_2x/delicious-carrot-cake-slice-with-cream-cheese-frosting-and-pecan-toppings-transparent-background-png.png', 'Moist and spiced with a hint of cinnamon, layered with smooth cream cheese frosting.');
 ...
 SELECT * FROM products where category = "sides";
